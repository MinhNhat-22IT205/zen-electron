...
import { createGroup, editGroup } from "../api/group.api";
import {
  RadioGroup,
  RadioGroupItem,
...
const EditGroupDialogMenuItem = ({ group }: { group: Group }) => {
  ...
  const onSubmit = async (values: ztAddGroupInputs) => {
    await editGroup(group._id, values);
...
export default EditGroupDialogMenuItem;
